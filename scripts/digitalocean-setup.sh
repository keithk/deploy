#!/bin/bash
# ABOUTME: Bootstrap script for deploying Deploy on fresh Ubuntu droplets.
# ABOUTME: Installs Bun, Docker, Caddy, Railpacks and prepares the environment.

# Deploy - DigitalOcean Quick Setup
# Run: curl -fsSL https://raw.githubusercontent.com/keithk/deploy/main/scripts/digitalocean-setup.sh | bash

set -e

echo "+==============================================================+"
echo "|              Deploy - DigitalOcean Setup                      |"
echo "+==============================================================+"
echo ""
...
# Install Railpacks (for building container images)
echo "==> Installing Railpacks..."
if command -v railpack &> /dev/null; then
    echo "Railpacks is already installed"
else
