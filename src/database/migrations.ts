...
export const migrations: Migration[] = [
  ...
  {
    version: 9,
    name: "add_actions_enabled_setting",
    up: `
      INSERT INTO system_settings (key, value, description) VALUES 
      ('actions_enabled', 'true', 'Enable or disable the action system (hooks, routes, scheduled tasks)');
    `,
    down: `DELETE FROM system_settings WHERE key = 'actions_enabled';`
  }
];
